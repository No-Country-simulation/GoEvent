...
class AuthController {
    static register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const serviceResponse = yield auth_service_1.default.register(req.body, req.file);
    ...
    static login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const serviceResponse = yield auth_service_1.default.login(req.body.email, req.body.password);
                if (serviceResponse.success === false) {
                    res.status(400).json(serviceResponse);
                    return;
                }
